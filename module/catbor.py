...
@Client.on_message(filters.command(["inf", "inffull"], prefix) & filters.me)
async def get_user_inf(client: Client, message: Message):
    is_full_info = message.command[0] == "inffull"
...
modules_help["user_info"] = {
    "inf": "Get brief information about user",
    "inffull": "Get full information about user",
}